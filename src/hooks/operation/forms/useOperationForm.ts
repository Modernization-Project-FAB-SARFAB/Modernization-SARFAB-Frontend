...
export function useOperationForm(defaultValues: CreateOperationForm) {
  ...
  const [operationContext, setOperationContext] = useState<CreateOperationContext | null>(null);
  ...
  return { ...form, setValue: form.setValue, operationContext, volunteers, military };
}
